...
#add kernel to package
  #kernel_path = "IMAGES/kernel"
  #namelist = input_zip.namelist()
  #if kernel_path in namelist:
  #  kernel_data = input_zip.read(kernel_path)
  #  common.ZipWriteStr(output_zip, "kernel", kernel_data)
  #else:
  #  print "Warning: cannot find kernel file in target_file package"

#add dtb to package
  #dtb_path = "IMAGES/dtb"
  #namelist = input_zip.namelist()
  #if dtb_path in namelist:
  #  dtb_data = input_zip.read(dtb_path)
  #  common.ZipWriteStr(output_zip, "dtb", dtb_data)
  #else:
  #  print "Warning: cannot find dtb file in target_file package"

#add root to package
  #rootfs_path = "IMAGES/root.img"
  #namelist = input_zip.namelist()
  #if rootfs_path in namelist:
  #  rootfs_data = input_zip.read(rootfs_path)
  #  common.ZipWriteStr(output_zip, "root.img", rootfs_data)
  #else:
  #  print "Warning: cannot find root.img file in target_file package"
  ...
  #script.FormatPartition("/root")
  #script.Mount("/root", recovery_mount_options)
  #script.UnpackPackageDir("root", "/root")

  #symlinks = CopyPartitionFiles(root_items, input_zip, output_zip)
  #script.MakeSymlinks(symlinks)

  #root_items.GetMetadata(input_zip)
  #root_items.Get("root").SetPermissions(script)
